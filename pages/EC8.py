  ...
  """)
    ...
    border-width: 2px;}</style><div class="dashed-line"></div>""",
      ...
      **και**
      ...
      $$\text{min} \text{V}_{\text{d}_\text{(y)}} = \dfrac{\gamma_{\text{Rd}} \cdot \text{M}_{\text{Rc,1}}^- + \left(\text{M}_{\text{Rc,2}}^+ \cdot \dfrac{\sum \text{M}_{\text{Rb,κάτω}}}{\sum \text{M}_{\text{Rc,κάτω}}}) \right}{\text{L}_{\text{cl}}}$$
