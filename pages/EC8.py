  ...
  """)
    ...
    border-width: 2px;}</style><div class="dashed-line"></div>""",
      ...
      ▧ Επειδή $$\sum \text{{M}}_{{\text{{Rb,άνω}}}} = {SMRb_a}\, \text{{kNm}} \geq \sum \text{{M}}_{{\text{{Rc,άνω}}}} = {SMRc_a}\, \text{{kNm}}$$ και $$\sum \text{{M}}_{{\text{{Rb,κάτω}}}} = {SMRb_k}\, \text{{kNm}} \geq \sum \text{{M}}_{{\text{{Rc,κάτω}}}} = {SMRc_k}\, \text{{kNm}}$$""")
            ...
            st.markdown(r"""
      $$\text{max} \text{V}_{\text{d}_\text{(y)}} = \gamma_{\text{\text{Rd}}} \cdot \dfrac{( \text{M}_{\text{Rc,}_{1}}^{+} + \text{M}_{\text{Rc,}_{2}}^{-} )}{\text{L}_{\text{cl}}}$$

      **και**

      $$\text{min} \text{V}_{\text{d}_\text{(y)}} = \gamma_{\text{\text{Rd}}} \cdot \dfrac{( \text{M}_{\text{Rc,}_{1}}^{-} + \text{M}_{\text{Rc,}_{2}}^{+} )}{\text{L}_{\text{cl}}}$$
