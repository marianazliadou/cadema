  ...
  """)
    ...
    border-width: 2px;}</style><div class="dashed-line"></div>""",
      ...
      **και**
      ...
      $$\text{minV}_{\text{d}_\text{(y)}} = - \gamma_{\text{\text{Rd}}} \cdot \dfrac\left[ \text{M}_{\text{Rc,1}}^{-} \cdot \dfrac{\sum \text{M}_{\text{Rb,άνω}}}{\sum \text{M}_{\text{Rc,άνω}}} + \text{M}_{\text{Rc,2}}^+ \right] }{\text{L}_{\text{cl}}}$$
